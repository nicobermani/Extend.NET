namespace Extend.NET.Enum
{
    public static partial class EnumExtensions
    {
        ...
        public static T GetEnumValueFromString<T>(this T value, string stringValue, bool ignoreCase = false) where T : System.Enum
        {
            if (!System.Enum.TryParse(typeof(T), stringValue, ignoreCase, out object result))
            {
